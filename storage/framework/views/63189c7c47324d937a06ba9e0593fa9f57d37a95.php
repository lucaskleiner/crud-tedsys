...
<?php $component->withAttributes([]); ?>
    ...
    <div class="my-12 p-6 max-w-3xl mx-auto shadow bg-white rounded-lg">
        <form action="<?php echo e(route('tarefas.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel-9-vite-crud\resources\views/tarefas/create.blade.php ENDPATH**/ ?>