...
<?php $component->withAttributes([]); ?>
    ...
    <div class="my-12 p-6 max-w-3xl mx-auto shadow bg-white rounded-lg">
        <form action="<?php echo e(route('tarefas.update', $tarefa->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <input value="<?php echo e($tarefa->title); ?>" name="title" type="text" id="title"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6 w-1/2">
                <img src="<?php echo e(asset('storage/app/public/media/tarefas/' . $tarefa->cover_image)); ?>" alt="cover iamge"
                    class="rounded">
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel-9-vite-crud\resources\views/tarefas/edit.blade.php ENDPATH**/ ?>